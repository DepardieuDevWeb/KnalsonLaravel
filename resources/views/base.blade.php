...
<head>
    ...
    <title>@yield('title') | Knalson Music</title>
    <link rel="stylesheet" href="{{ asset('css/style.css') }}">
    <script src="js/sous-menu.js" defer></script>
    <script src="js/menu-hamburger.js" defer></script>
    <script src="js/intObserver.js" defer></script>
    ...
    <header>
        <nav class="navbar">
            ...
            <div class="navbar-menu">
                <li class="li-lien"><a href="{{ route('home') }}" id="1" class="liens">Accueil</a></li>
                <li class="li-lien"><a href="{{ route('benefits') }}" id="2" class="liens">Nos prestations</a></li>
                <div class="dropdown li-lien">
                    ...
                    <div class="sous-menu">
                        <a href="{{ route('images') }}" id="6" class="liens">Nos images</a>
                        <a href="{{ route('videos') }}" id="7" class="liens">Nos videos</a>
                    </div>
                </div>
                <li class="li-lien"><a href="{{ route('events') }}" id="3" class="liens">Nos dates à venir</a></li>
                <li class="li-lien"><a href="{{ route('contact') }}" id="4" class="liens">Contact</a></li>
            </div>
        ...
        <div class="header-presentation reveal">
            <h1 class="reveal-1">@yield('title_page') <span class='logo-span'>@yield('span')</span></h1>
            <p class="reveal-2">@yield('paragraph')</p>
        </div>
    </header>
